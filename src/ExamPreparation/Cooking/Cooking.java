...
public class Cooking {
    public static void main(String[] args) {
        ...
        ArrayDeque<Integer> liquids = Arrays.stream(scanner.nextLine().split("\\s+"))
                ...
                .collect(Collectors.toCollection(ArrayDeque::new));     //queue poll
        ...
        System.out.printf("Liquids left: %s%n", remainingLiquids);

        String remainingIngredients = ingredients.isEmpty() ? "none" : ingredients.stream()
                .map(String::valueOf)
                .collect(Collectors.joining(", "));
        System.out.printf("Ingredients left: %s%n", remainingIngredients);
